...
// Gantt modules — weeks taken EXACTLY from the approved Gantt chart.
...
export const modules = [
  {
    ...
    progress: 70,
    detail:
      'Hardcopy data is being converted into softcopy (digital form). 70% complete — remaining relevant data is still pending.',
  },
  {
    id: 2,
...
// Weighted overall completion (by module duration in weeks).
